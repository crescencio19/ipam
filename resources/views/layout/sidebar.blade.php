<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">IPAM</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Request::is('/') ? 'active' : '' }}">
              <a href="{{ url('/') }}" class="menu-link">
                ...
                <div data-i18n="Analytics">Domains Range</div>
              </a>
            </li>
            <li class="menu-item {{ Request::routeIs('vlan.dashboard') ? 'active' : '' }}">
              <a href="{{ route('vlan.dashboard') }}" class="menu-link">
            ...
            <li class="menu-item {{ $dataMasterActive ? 'active open' : '' }}">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ Request::routeIs('domain.domain') ? 'active' : '' }}">
                        <a href="{{ route('domain.domain') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ Request::routeIs('ip.ip') ? 'active' : '' }}">
                        <a href="{{ route('ip.ip') }}" class="menu-link">
