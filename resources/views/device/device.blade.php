...
<nav
  ...
  id="layout-navbar"
>
 <form action="{{ route('device.device') }}" method="GET" class="navbar-nav align-items-center">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="device" class="form-control" value="{{ $item->device }}" required>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Update</button>
                    ...
                    <div class="modal fade" id="deleteModal{{ $item->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $item->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{ route('device.destroy', $item->id) }}" method="POST">
                                @csrf
                                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="basicModal" tabindex="-1" aria-labelledby="basicModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('device.store') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="basicModalLabel">New Device</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="mb-3">
                            <label for="vlanid" class="form-label">Device</label>
                            <input type="text" name="device" id="device" class="form-control" placeholder="device" required>
                    </div>
